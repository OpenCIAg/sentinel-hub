...
(function (SentinelHubWms) {
    ...
    function getImage(uuid, bbox, options) {
        return __awaiter(this, void 0, void 0, function* () {
            let getMap = new GetMap_1.GetMap.GetMap(uuid, { DATE: options.date, BBOX: bbox, FORMAT: WMSParameters.Format.image_png, LAYERS: options.layers, WIDTH: "1024", HEIGHT: "780" });
